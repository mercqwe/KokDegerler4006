      ...
      <div className="absolute inset-0 opacity-[0.03] pointer-events-none">
        <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
          <pattern id="pattern" x="0" y="0" width="40" height="40" patternUnits="userSpaceOnUse">
            <path d="M20 0L40 20L20 40L0 20Z" fill="currentColor" className="text-slate-900" />
          </pattern>
      ...
      <div className="container relative mx-auto px-4">
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-slate-600">
            Karakterimizi şekillendiren bu değerler, yüzyıllardır atasözlerimizde hayat buluyor. 
            İncelemek istediğiniz değeri seçin.
          </p>
        </div>
              ...
              >
                <Card className="relative h-full overflow-hidden border border-slate-200 bg-white shadow-sm transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-cyan-900/10 hover:border-cyan-200">
                  ...
                  <CardContent className="flex flex-col items-center p-8 text-center">
                    ...
                    >
                      {Icon && <Icon className="size-8 transition-transform group-hover:scale-110" />}
                    </div>
